...
Feltor<Matrix, container, P>::Feltor( const Grid& g, eule::Parameters p, solovev::GeomParameters gp): 
    ...
    poisson(g, g.bcx(), g.bcy(), dg::DIR, dg::DIR), 
